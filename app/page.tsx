...
const ClassificationChart = dynamic(() => import('@/components/dashboard/charts').then(mod => mod.ClassificationChart), {
  loading: () => <p>Loading...</p>,
});

const ValueByOriginChart = dynamic(() => import('@/components/dashboard/charts').then(mod => mod.ValueByOriginChart), {
  loading: () => <p>Loading...</p>,
});
